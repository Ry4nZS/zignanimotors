...
Foi desenvolvida como projeto de portfólio para consolidar conhecimentos em backend com Java e Spring.
...
Isso evita exposição direta das entidades e melhora a organização da API.
...
Projeto desenvolvido como parte da evolução prática em backend Java e construção de portfólio profissional.
